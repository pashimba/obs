...
var Util = {
	...
	isCanvasFarblingActive() {
		...
		for (let i = 0; i < 100; i++) if (d[i * 4] !== 40 || d[i * 4 + 1] !== 40 || d[i * 4 + 2] !== 40 || d[i * 4 + 3] !== 255) {
			isFarbling = true;
			break;
		}
	...
	drawRoundedPolygonPath(context, points, sides, radius, cornerRadius) {
		...
		for (let i = 0; i < sides; i++) {
			...
			else currCornerRadius = i < cornerRadius.length ? cornerRadius[i] : 0;
...
var Node = class Node {
	...
	on(...args) {
		...
		if (args.length === 3) return this._delegate.apply(this, args);
	...
	remove() {
		...
		DD._dragElements.forEach((elem, key) => {
			if (this.isAncestorOf(elem.node)) DD._dragElements.delete(key);
		});
		this._remove();
		return this;
	}
...
//#endregion
export { Util as _, getNumberArrayValidator as a, glob as b, getNumberValidator as c, DD as d, Canvas as f, Transform as g, Context as h, getBooleanValidator as i, getStringOrGradientValidator as l, SceneCanvas as m, Factory as n, getNumberOrArrayOfNumbersValidator as o, HitCanvas as p, RGBComponent as r, getNumberOrAutoValidator as s, Node as t, getStringValidator as u, Konva as v, _registerNode as y };

//# sourceMappingURL=Node-0ybsHk62.js.map